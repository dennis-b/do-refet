...
export default function RTLPage() {
    ...
    color = "warning" >
      ...
      < /CardIcon>
      < p
    className = { classes.cardCategory } > فضا
    مصرف
    شده < /p>
    < h3
...
<
    ...
    color = "success" >
      ...
      < /CardIcon>
      < p
    className = { classes.cardCategory } > سود < /p>
      < h3
    className = { classes.cardTitle } > $34, 245 < /h3>
    < /CardHeader>
    < CardFooter
    stats >
    < div
    ...
    color = "danger" >
      ...
      < /CardIcon>
      < p
    className = { classes.cardCategory } > مشکلات
    حل
    شده < /p>
    < h3
    className = { classes.cardTitle } > 75 < /h3>
      < /CardHeader>
      < CardFooter
    stats >
    < div
    ...
    color = "info" >
      ...
      < /CardIcon>
      < p
    className = { classes.cardCategory } > دنبال‌کننده < /p>
      < h3
    className = { classes.cardTitle } > +245 < /h3>
      < /CardHeader>
      < CardFooter
    stats >
    < div
    ...
    < CardBody >
    < h4
    className = { classes.cardTitle } > فروش
    روزانه < /h4>
    < p
    ...
    < CardBody >
    < h4
    className = { classes.cardTitle } > دنبال
    کننده‌های
    ایمیلی < /h4>
    < p
    className = { classes.cardCategory } > کارایی
    آخرین
    کمپین < /p>
    < /CardBody>
    < CardFooter
    ...
    < CardBody >
    < h4
    className = { classes.cardTitle } > وظایف
    انجام
    شده < /h4>
    < p
    className = { classes.cardCategory } > کارایی
...
,
    ...
    color = "warning" >
      < h4
    className = { classes.cardTitleWhite } > آمار
    کارکنان < /h4>
    < p
...
<
    ...
    color = "primary" >
      < h4
    className = { classes.cardTitleWhite } > اعلان
    ها < /h4>
    < p
    className = { classes.cardCategoryWhite } >
      يدويا
...
<
    ...
    profile >
    < h6
    className = { classes.cardCategory } > مدیرعامل / مدیرفنی < /h6>
      < h4
    className = { classes.cardTitle } > خداداد
    عزیزی < /h4>
    < p
